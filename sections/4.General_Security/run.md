...
-e "mysql_pass=MatKhau@123": Cờ -e là viết tắt của extra variables (biến bổ sung/biến ngoại lai). Đoạn này cho phép bạn truyền trực tiếp một biến có tên là mysql_pass với giá trị là MatKhau@123 vào trong playbook ngay lúc chạy.

Tác dụng: Bất kỳ chỗ nào trong file .yml của bạn gọi {{ mysql_pass }}, nó sẽ nhận giá trị này. Đặc biệt, biến truyền từ -e có độ ưu tiên cao nhất, nó sẽ ghi đè (override) mọi giá trị mysql_pass đang được viết sẵn bên trong file .yml. 
-->
